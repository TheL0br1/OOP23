...
public class MyFunctions {
    ...
    public static void deleteEntities() {
        main.Entities.forEach(En -> {
            ...
            try {
                main.writer.write("Delete micro: " + En.toString() + "\n");
                main.writer.flush();
            } catch (IOException e) {
    ...
    public static void serializeImage() {
        ...
        gc.drawImage(main.stage.getScene().snapshot(null), 5, 5, 200 - 5, 260 - 5);
        gc.setStroke(Color.RED);
        gc.setLineWidth(5.0);
        gc.strokeRect(0, 0, main.miniMapCanvas.getWidth(), main.miniMapCanvas.getHeight());
        gc.setStroke(Color.GRAY);
        gc.setLineWidth(3);
        double x = -main.relateX * main.stage.getX();
        double y = main.relateY * main.stage.getY();
        gc.strokeRect(-main.relateX * main.stage.getX(), -main.relateY * main.stage.getY(), 80, 60);
    ...
    public static void moveToMacro() {
        main.Entities.forEach(en -> {
            ...
            AnimationTimer timer = new AnimationTimer() {
                double x1 = main.macroObjects.get(finalIndex).getCanvas().getLayoutX();
                double y1 = main.macroObjects.get(finalIndex).getCanvas().getLayoutY();
                Objects en1 = en;
                double x2 = (x1 - en.getCanvas().getLayoutX()) / 10;
                double y2 = (y1 - en.getCanvas().getLayoutY()) / 10;
                int i = 0;
